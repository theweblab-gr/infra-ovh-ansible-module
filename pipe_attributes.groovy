...
node(Slave_Node){
       ...
       stage('First Stage'){
              ...
              sh "ANSIBLE_HOST_KEY_CHECKING=false ansible-playbook infra-ovh-ansible.yaml --tags ovh-servers-list -vv --module-path ./library/infra-ovh-ansible-module/modules/extras/cloud/ovh"
