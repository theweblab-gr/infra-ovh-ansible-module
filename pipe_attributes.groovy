...
node(Slave_Node){
       ...
       stage('First Stage'){
              ...
              checkout scm
              sh "ls -al"
              ansiblePlaybook colorized: true, disableHostKeyChecking: true, installation: 'Ansible_1', inventory: 'hosts', playbook: 'infra-ovh-ansible.yaml', tags: 'ovh-servers-list'
