...
node(Slave_Node){
       ...
       stage('First Stage'){
              ...
              sh "ANSIBLE_HOST_KEY_CHECKING=false ansible-playbook infra-ovh-ansible.yaml --tags ovh-servers-list,ovh-templates-list -vv --extra-vars  application_key='provide_ovh_app' application_secret='provide_secrete'  "
